...
public class BookResource {
    ...
    @GetMapping("/books/booksWithPrice/{priice}")
    @Timed
    public Book getAllBooksWithPricesHigherThen(@PathVariable double priice) {
        log.debug("REST request to get a page of Books");
        Book book = bookRepository.getAllBooksWithPricesHigherThen(priice);
        return book;
    }

 
    @GetMapping("/books/booksPriceIs")
    @Timed
    public Book getBooksPriceIs() {
        log.debug("REST request to get a page of Books");
        Book book = bookRepository.getBookPriceis();
        System.out.println("holaaa");
        return book;
    }
    
    @GetMapping("/books/totalbooks")
    @Timed
    public List<Integer> getTotalBooks() {
        log.debug("REST request to get a page of Books");
        Integer books = bookRepository.getTotalBooks();
    ...
    public List<Integer> getTotalPrice() {
        log.debug("REST request to get a page of Books");
        Integer books = bookRepository.getTotalPrice();
        List<Integer> b= new ArrayList<>();
        b.add(books);
        return b;
    }
